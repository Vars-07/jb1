...
xmlhttp.open("GET","viewlog.php?uid="+uid+"&date="+date,true);
xmlhttp.send();
}
</script>
            ...
            <div class="main_con">
            	<div class="left_col">
            	  ...
            	  <div class="main_news_con">
						...
						<tr><td><h3>Enter Date</h3></td>
                        <td><select name="date" id="date" onchange="getlog()">
                            <option value="">All Log</option>
                            <option value="2011-10-30">30th Oct</option>
                            <option value="2011-10-31">31st Oct</option>
                            <option value="2011-11-01">1st Nov</option>
                            <option value="2011-11-02">2nd Nov</option>
                            <option value="2011-11-03">3rd Nov</option>
                            <option value="2011-11-04">4th Nov</option>
                            <option value="2011-11-05">5th Nov</option>
                            <option value="2011-11-06">6th Nov</option>
                            <option value="2011-11-07">7th Nov</option>
                            <option value="2011-11-08">8th Nov</option>
                            <option value="2011-11-09">9th Nov</option>
                            <option value="2011-11-10">10th Nov</option>
                            <option value="2011-11-11">11th Nov</option>
                            <option value="2011-11-12">12th Nov</option>
