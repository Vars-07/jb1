...
<?php
$i=0;
$sql="select * from profile where usertype='user' and flag=0 order by experience desc ,money desc Limit 0,5";
    ...
    <ul>
        <li>
            ...
            <div class="lt_box_topicthreads">
                <a style="text-transform: capitalize;font-size: 12PT" >    <?php echo $data['name'];?></a>
            </div>
