                ...
                <div class="left_col">
                    <div class="slideshow_con">
                        <div class="wrapper">
                            <div id="slidewrap">
                                <ul class="slideshow">
                                    <li><a href="#"><img src="images/index1.jpg" height="222px" width="667px" title="Job Bureau v5.0" alt="The best way to appreciate your job is to imagine yourself without one."/></a></li>
                                    <li><a href="#"><img src="images/index2.jpg" height="222px" width="667px" title="Job Bureau v5.0" alt="If a job is worth doing, it's worth doing well"/></a></li>
                                    <li><a href="#"><img src="images/index3.jpg" height="222px" width="667px" title="Job Bureau v5.0" alt="If you do a good job for others, you heal yourself at the same time, because a dose of joy is a spiritual cure"/></a></li>
                                    <li><a href="#"><img src="images/index4.jpg" height="222px" width="667px" title="Job Bureau v5.0" alt="If a job is worth doing, it's worth doing well"/></a></li>
                                    <li><a href="#"><img src="images/index5.jpg" height="222px" width="667px" title="Job Bureau v5.0" alt="Big jobs usually go to the men who prove their ability to outgrow small ones."/></a></li>
                                </ul>
                            </div>
                            <div class="clr" ></div>
                        </div>
 ...
 <!--<h2 style="margin-top: 5px; margin-left: 20px; color:blue;text-align:justify;" align="center">The Game is Over !!Thank You For playing 'Job Bureau-A Real Time Office Simulation' and giving us your valuable time.</h2>--->
                           ...
                           <div class="main_news_post_text_con1">
                                ...
                                <div class="main_news_post_text" style="margin-top: 30px" >
                                   ...
                                   <p  style="padding-left: 10px;font-size: 120%">Login by using your <strong>Infotsav 'Username' and 'Password'</strong>. If you have not registered yet then visit the link: <a href="http://www.infotsav.com" target="_blank">http://infotsav.com </a>and kindly register yourself. </p>
                                </div>
            ...
            <!--<div id="loginContainer">
                ...
                <div id="loginBox">                
                    <form id="loginForm" action="logincheck1.php" onsubmit="" method="post">
                        ...
                        <span><a href="http://www.infotsav.">Forgot your password?</a></span>
                    </form>
                </div>
            </div>-->
            <!-- Login Ends Here -->
								    <div class="right_col_header">
                            <span>+ User <span>&nbsp;Login</span>  <!--<fb:login-button autologoutlink="true" perms="email"></fb:login-button>&nbsp;<img title="To login through facebook, you may need to allow pop-ups in your web browser. After allowing pop-ups, allow permissions for Job Bureau application and then refresh." src="images/question_fb_help.jpg " />--></span>
                        </div>

                        <div class="sponsor_img_con2">
							<?php
								$sql = "select login from gamestatus where status=1";
								$res = mysql_query($sql);
								$res = mysql_fetch_row($res);
                            ?>
								<form action="<?php echo $res[0]; ?>" onsubmit="" method="post">
								<h2 align="center"><font color="#FFFFFF" face="calibri">	Username</font><font color="#FFFFFF" face="calibri">/</font><font color="#F8711E">Email</font></h2><br/>
