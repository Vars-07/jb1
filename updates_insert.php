            	...
            	<div class="left_col">
            	  ...
            	  <div class="main_news_con">
                    	<div class="main_news_post">
                    	  <div class="clr">
                    	<form name="newad" method="post" enctype="multipart/form-data" action="insertupdates.php">
                            <?php
                        $error=$_GET['error'];
                        if($error==0)
                        {
                        ...
                        <tr><td valign="top"><h3>New Update: </h3></td>

                         <td> <label>
                            <textarea name="update" id="textarea" cols="30" rows="5"></textarea>
                          </label></td>
                        </tr>
						<tr></tr>
						<tr></tr>
